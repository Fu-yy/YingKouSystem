# 文件结构：
    - 侧边栏显示：common/Siderbar.vue
    - 打开的标签管理：页面上部标签选项：common/Tags.vue
    - 整个页面的框架->包含所有组件  common/Home.vue
    - 页面最上面的一条组件，包括登出等按钮  common/Header.vue

    - 其他组件全在page里面，总体页面样式在assets/css中 组件单独样式在自己的页面中并用scopped修饰

    项目启动方式-npm run dev 默认端口8080
